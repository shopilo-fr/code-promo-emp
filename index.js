 ...
 * Homepage: https://shopilo.fr/reductions/emp-online.fr
 */

const SHOPILO_URL = "https://shopilo.fr/reductions/emp-online.fr";
const STORE_NAME  = "EMP";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-fr/code-promo-emp)" }
  });
