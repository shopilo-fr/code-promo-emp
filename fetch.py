#!/usr/bin/env python3
"""
Recuperation des codes promo EMP depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/emp-online.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/emp-online.fr"
STORE_NAME = "EMP"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour EMP depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-emp)"
    }
    try:
